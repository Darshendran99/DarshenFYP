...
class Home extends BaseController
{
    public function index()
    {
        ...
        $data['product'] = $product_model->orderBy('ProductPrice', 'ASC')
            ->first();
        $data['promotion'] = $promotion_model->orderBy('PromotionPrice', 'ASC')
            ->first();
        $data['component'] = $component_model->orderBy('ComponentPrice', 'ASC')
            ->first();
        ...
        $query = $builder->orderBy("MONTH(gpuUpdatedDate)", "asc")
            ->get();
        ...
        $query = $builder->orderBy("MONTH(cpuUpdatedDate)", "asc")
            ->get();
        $record = $query->getResult();
        $cpuchart = [];
        foreach ($record as $row)
    ...
    public function Login()
    {
        ...
        {
            //Validation
            $rules = ['email' => 'required|min_length[6]|max_length[50]|valid_email', 'password' => 'required|min_length[8]|max_length[255]|validateUser[email,password]', ];
            ...
            {
                // ReCaptcha
                $recaptchaResponse = trim($this
                    ->request
                    ->getVar('g-recaptcha-response'));
    ...
    {
        $data = ['id' => $user['id'], 'firstname' => $user['firstname'], 'lastname' => $user['lastname'], 'email' => $user['email'], 'isLoggedIn' => true, ];
    ...
    public function Register()
    {
        ...
        {
            //Validation
            $rules = ['firstname' => 'required|min_length[2]|max_length[25]', 'lastname' => 'required|min_length[2]|max_length[25]', 'address' => 'required|min_length[10]|max_length[255]', 'email' => 'required|min_length[6]|max_length[50]|valid_email|is_unique[users.email]', 'password' => 'required|min_length[8]|max_length[255]', 'password_confirm' => 'matches[password]', ];
            ...
            else
            {
                ...
                if ($status['success'])
                {
                    ...
                    $model = new UserModel();
                    $newData = ['firstname' => $this
                        ->request
                        ->getVar('firstname') , 'lastname' => $this
                        ->request
                        ->getVar('lastname') , 'address' => $this
                        ->request
                        ->getVar('address') , 'email' => $this
                        ->request
                        ->getVar('email') , 'password' => $this
                        ->request
                        ->getVar('password') , ];
                    $model->save($newData);
                    $session = session();
    ...
    {
        $component_model = new component_model();
        $data['component'] = $component_model->orderBy('ComponentId', 'ASC')
            ->findAll();
    ...
    {
        $product_model = new product_model();
        $data['product'] = $product_model->orderBy('CreatedOn', 'DESC')
            ->findAll();
    ...
    {
        $promotion_model = new promotion_model();
        $data['promotion'] = $promotion_model->orderBy('PromoCreatedOn', 'DESC')
            ->findAll();
    ...
    public function AddCart1($ProductId)
    {
        ...
        if (session()->get('isLoggedIn'))
        {
            ...
            else
            {
                ...
                {
                    $cart_model = new cart_model();
                    $cartData1 = ['uid' => session('id') , 'ProductId' => $productCartitem['ProductId'], 'itemName' => $productCartitem['ProductName'], 'itemImage' => $productCartitem['ProductImage'], 'itemPrice' => $productCartitem['ProductPrice'], ];
                }
    ...
    public function AddCart2($PromotionId)
    {
        ...
        if (session()->get('isLoggedIn'))
        {
            ...
            else
            {
                ...
                {
                    $cart_model = new cart_model();
                    $cartData2 = ['uid' => session('id') , 'PromotionId' => $promotionCartitem['PromotionId'], 'itemName' => $promotionCartitem['PromotionName'], 'itemImage' => $promotionCartitem['PromotionImage'], 'itemPrice' => $promotionCartitem['PromotionPrice'], ];
                }
    ...
    public function AddCart3()
    {
            ...
            ->getMethod() == 'post')
        {
            ...
            if ($intelCpuComponent != "")
            {
                ...
                $cartData3 = ['uid' => session('id') , 'ComponentId' => $getComponentData1['ComponentId'], 'itemName' => $getComponentData1['ComponentName'], 'itemImage' => $getComponentData1['ComponentImage'], 'itemPrice' => $getComponentData1['ComponentPrice'], ];
            ...
            if ($amdCpuComponent != "")
            {
                ...
                $cartData4 = ['uid' => session('id') , 'ComponentId' => $getComponentData2['ComponentId'], 'itemName' => $getComponentData2['ComponentName'], 'itemImage' => $getComponentData2['ComponentImage'], 'itemPrice' => $getComponentData2['ComponentPrice'], ];
            ...
            if ($intelMoboComponent != "")
            {
                ...
                $cartData5 = ['uid' => session('id') , 'ComponentId' => $getComponentData3['ComponentId'], 'itemName' => $getComponentData3['ComponentName'], 'itemImage' => $getComponentData3['ComponentImage'], 'itemPrice' => $getComponentData3['ComponentPrice'], ];
            ...
            if ($amdMoboComponent != "")
            {
                ...
                $cartData6 = ['uid' => session('id') , 'ComponentId' => $getComponentData4['ComponentId'], 'itemName' => $getComponentData4['ComponentName'], 'itemImage' => $getComponentData4['ComponentImage'], 'itemPrice' => $getComponentData4['ComponentPrice'], ];
            ...
            if ($intelGpuComponent != "")
            {
                ...
                $cartData7 = ['uid' => session('id') , 'ComponentId' => $getComponentData5['ComponentId'], 'itemName' => $getComponentData5['ComponentName'], 'itemImage' => $getComponentData5['ComponentImage'], 'itemPrice' => $getComponentData5['ComponentPrice'], ];
            ...
            if ($amdGpuComponent != "")
            {
                ...
                $cartData7 = ['uid' => session('id') , 'ComponentId' => $getComponentData6['ComponentId'], 'itemName' => $getComponentData6['ComponentName'], 'itemImage' => $getComponentData6['ComponentImage'], 'itemPrice' => $getComponentData6['ComponentPrice'], ];
            ...
            if ($nvidiaGpuComponent != "")
            {
                ...
                $cartData8 = ['uid' => session('id') , 'ComponentId' => $getComponentData7['ComponentId'], 'itemName' => $getComponentData7['ComponentName'], 'itemImage' => $getComponentData7['ComponentImage'], 'itemPrice' => $getComponentData7['ComponentPrice'], ];
            ...
            if ($ram_Component != "")
            {
                ...
                $cartData9 = ['uid' => session('id') , 'ComponentId' => $getComponentData7['ComponentId'], 'itemName' => $getComponentData7['ComponentName'], 'itemImage' => $getComponentData7['ComponentImage'], 'itemPrice' => $getComponentData7['ComponentPrice'], ];
            ...
            if ($ssd_Component != "")
            {
                ...
                $cartData10 = ['uid' => session('id') , 'ComponentId' => $getComponentData8['ComponentId'], 'itemName' => $getComponentData8['ComponentName'], 'itemImage' => $getComponentData8['ComponentImage'], 'itemPrice' => $getComponentData8['ComponentPrice'], ];
            ...
            if ($psu_Component != "")
            {
                ...
                $cartData11 = ['uid' => session('id') , 'ComponentId' => $getComponentData9['ComponentId'], 'itemName' => $getComponentData9['ComponentName'], 'itemImage' => $getComponentData9['ComponentImage'], 'itemPrice' => $getComponentData9['ComponentPrice'], ];
            ...
            if ($casing_Component != "")
            {
                ...
                $cartData12 = ['uid' => session('id') , 'ComponentId' => $getComponentData10['ComponentId'], 'itemName' => $getComponentData10['ComponentName'], 'itemImage' => $getComponentData10['ComponentImage'], 'itemPrice' => $getComponentData10['ComponentPrice'], ];
    ...
    public function Payment()
    {
        ...
        if ($NumberOfCartItem > 0)
        {
                ...
                ->getMethod() == 'post')
            {
                ...
                $CardDetails = $this
                    ->request
                    ->getVar('cardname') . "," . $this
                    ->request
                    ->getVar('cardnumber') . "," . $this
                    ->request
                    ->getVar('expmonth') . "," . $this
                    ->request
                    ->getVar('expyear') . "," . $this
                    ->request
                    ->getVar('cvv');
                $total_price_sum = $this
                    ->request
                    ->getVar('totalPrice');
                ...
                else
                {
                    ...
                    $newData = ['userid' => session('id') , 'Name' => $this
                        ...
                        ->request
                        ->getVar('email') , 'PaymentAddress' => $PaymentAddress, 'CardDetails' => $CardDetails, 'PaymentTotal' => $total_price_sum, 'PaidItems' => $this
                        ->request
                    ...
                    {
                      $session = session();
                      $session->set('AbleToPlayGame', 'true');
    ...
    public function CODPayment()
    {
        ...
        if ($NumberOfCartItem > 0)
        {
            ...
            {
                //Validation
                $rules = ['name' => 'required|min_length[2]|max_length[25]|alpha_space', 'email' => 'required|min_length[6]|max_length[50]|valid_email', 'address' => 'required|min_length[10]|max_length[255]|alpha_numeric_punct', 'city' => 'required|min_length[4]|max_length[50]|alpha_space', 'state' => 'required|min_length[4]|max_length[50]|alpha_space', 'zip' => 'required|min_length[4]|max_length[50]|integer',
    ...
    public function Game()
    {
      if (session()->get('AbleToPlayGame')) {
        ...
        $data['rewardTier1'] = $reward_model->where('RewardTier', '1')
            ->first();
        $data['rewardTier2'] = $reward_model->where('RewardTier', '2')
            ->first();
        $data['rewardTier3'] = $reward_model->where('RewardTier', '3')
            ->first();
        ...
        $session = session();
        $session->setFlashdata('Error', 'Game Reward Page Only Available For Purcahses Above A Certain Ammount');
        return redirect()->to('');
      }
    }
    ...
    public function GameReward($RewardID = null)
    {
        if (session()->get('isLoggedIn'))
        {
            ...
            $data['paymentDate'] = $checkPaymentID->orderBy('PaymentId', 'DESC')
                ->first();
            $paymentDate = $data['paymentDate'];
            ...
            $freeRewardOrder = ['userId' => session('id') , 'paymentId' => $orderPaymentId, 'shippingAddress' => "Same As Order Above", 'itemsOrdered' => $freeItem, 'grandTotal' => "0000", 'orderStatus' => "0", ];
    ...
    public function updateAccount()
    {
        ...
        {
            //Validation
            $rules = ['firstname' => 'required|min_length[2]|max_length[25]', 'lastname' => 'required|min_length[2]|max_length[25]', 'address' => 'required|min_length[10]|max_length[255]', 'email' => 'required|min_length[6]|max_length[50]|valid_email', 'password' => 'required|min_length[8]|max_length[255]', 'password_confirm' => 'matches[password]', ];
