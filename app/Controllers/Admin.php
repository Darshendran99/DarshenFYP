...
class Admin extends BaseController
{
    ...
    public function AdminRegister()
    {
        ...
        {
            //Validation
            $rules = ['name' => 'required|min_length[2]|max_length[50]', 'email' => 'required|min_length[6]|max_length[50]|valid_email|is_unique[admin.staffEmail]', 'password' => 'required|min_length[8]|max_length[255]', 'password_confirm' => 'matches[password]', ];
            ...
            else
            {
                ...
                if ($status['success'])
                {
                    ...
                    $newData = ['staffName' => $this
                        ->request
                        ->getVar('name') , 'staffEmail' => $this
                        ->request
                        ->getVar('email') , 'stafPassword' => $this
                        ->request
                        ->getVar('password') , ];
                    $model->save($newData);
                    $session = session();
    ...
    public function AdminLogin()
    {
        ...
        {
            //Validation
            $rules = ['staffEmail' => 'required|min_length[6]|max_length[50]|valid_email', 'stafPassword' => 'required|min_length[8]|max_length[255]|validateAdmin[staffEmail,stafPassword]', ];
            $errors = ['stafPassword' => ['validateAdmin' => 'Email or Password don\'t match']];
            ...
            else
            {
                ...
                if ($status['success'])
                {
                    // Recaptcha
                    $model = new admin_model();
                    $admin = $model->where('staffEmail', $this
                        ->request
                        ->getVar('staffEmail'))
                        ->first();
    ...
    {
        $data = ['StaffId' => $admin['StaffId'], 'staffName' => $admin['staffName'], 'staffEmail' => $admin['staffEmail'], 'AdminisLoggedIn' => true, ];
    ...
    public function UsersTable()
    {
            ...
            ->get('AdminisLoggedIn'))
        {
            ...
            $UserModel = new UserModel();
            $data['usersTable'] = $UserModel->orderBy('id', 'ASC')
                ->findAll();
    ...
    public function ProductsTable()
    {
            ...
            ->get('AdminisLoggedIn'))
        {
            ...
            $data['productsTable'] = $product_model->orderBy('ProductId', 'ASC')
                ->findAll();
    ...
    public function PromotionsTable()
    {
            ...
            ->get('AdminisLoggedIn'))
        {
            ...
            $data['promotionsTable'] = $promotion_model->orderBy('PromotionId', 'ASC')
                ->findAll();
    ...
    public function ComponentsTable()
    {
            ...
            ->get('AdminisLoggedIn'))
        {
            ...
            $data['componentsTable'] = $component_model->orderBy('ComponentId', 'ASC')
                ->findAll();
    ...
    public function RewardsTable()
    {
            ...
            ->get('AdminisLoggedIn'))
        {
            ...
            $data['rewardsTable'] = $reward_model->orderBy('RewardID', 'ASC')
                ->findAll();
    ...
    public function PaymentsTable()
    {
            ...
            ->get('AdminisLoggedIn'))
        {
            ...
            $data['paymentsTable'] = $payment_model->orderBy('PaymentId', 'ASC')
                ->findAll();
    ...
    public function CPUsTable()
    {
            ...
            ->get('AdminisLoggedIn'))
        {
            ...
            $data['cpusTable'] = $cpu_model->orderBy('cpuId', 'ASC')
                ->findAll();
    ...
    public function GPUsTable()
    {
            ...
            ->get('AdminisLoggedIn'))
        {
            ...
            $data['gpusTable'] = $cpu_model->orderBy('gpuId', 'ASC')
                ->findAll();
    ...
    public function AdminsTable()
    {
            ...
            ->get('AdminisLoggedIn'))
        {
            ...
            $admin_model = new admin_model();
            $data['adminsTable'] = $admin_model->orderBy('StaffId', 'ASC')
                ->findAll();
    ...
    public function AddProduct()
    {
            ...
            ->get('AdminisLoggedIn'))
        {
            ...
            {
                //Validation
                $rules = ['productname' => 'required|min_length[10]|max_length[50]', 'productimage' => 'uploaded[productimage]|is_image[productimage]|max_size[productimage,4000]', 'productprice' => 'required|min_length[1]|max_length[255]|integer', 'productLink' => 'required|min_length[35]|max_length[60]', 'productcpu' => 'required|min_length[5]|max_length[50]', 'productgpu' => 'required|min_length[5]|max_length[50]', 'productmobo' => 'required|min_length[5]|max_length[50]', 'productram' => 'required|min_length[5]|max_length[50]', 'productssd' => 'required|min_length[5]|max_length[50]', 'productpsu' => 'required|min_length[5]|max_length[50]', 'productcasing' => 'required|min_length[5]|max_length[50]', 'productother' => 'max_length[50]', 'productcsgo' => 'required|min_length[1]|max_length[50]|integer', 'productfortnite' => 'required|min_length[1]|max_length[50]|integer', 'productgtav' => 'required|min_length[1]|max_length[50]|integer', 'productcyberpunk' => 'required|min_length[1]|max_length[50]|integer', 'product3dmark' => 'required|min_length[1]|max_length[50]|integer', 'productgeekbench' => 'required|min_length[1]|max_length[50]|integer', ];
                ...
                else
                {
                    ...
                    $newData = ['ProductName' => $this
                        ->request
                        ->getVar('productname') , 'ProductImage' => $image, 'ProductPrice' => $this
                        ->request
                        ->getVar('productprice') , 'productLink' => $this
                        ->request
                        ->getVar('productLink') , 'ProductCPU' => $this
                        ->request
    ...
    public function AddPromotion()
    {
            ...
            ->get('AdminisLoggedIn'))
        {
            ...
            {
                //Validation
                $rules = ['promotionname' => 'required|min_length[10]|max_length[50]', 'promotionimage' => 'uploaded[promotionimage]|is_image[promotionimage]|max_size[promotionimage,4000]', 'promotionoriprice' => 'required|min_length[1]|max_length[10]|integer', 'promotionprice' => 'required|min_length[1]|max_length[10]|integer', 'promotioncpu' => 'max_length[50]', 'promotiongpu' => 'max_length[50]', 'promotionmobo' => 'max_length[50]', 'promotionram' => 'max_length[50]', 'promotionssd' => 'max_length[50]', 'promotionpsu' => 'max_length[50]', 'promotioncasing' => 'max_length[50]', 'promotionother' => 'max_length[50]', 'nonpcdetails' => 'max_length[50]', 'promotiondetail1' => 'max_length[50]', 'promotiondetail2' => 'max_length[50]', 'promotiondetail3' => 'max_length[50]', 'promotiondetail4' => 'max_length[50]', ];
                ...
                else
                {
                    ...
                    $newData = ['PromotionName' => $this
                        ...
                        ->request
                        ->getVar('promotionstatus') , 'PromotionImage' => $image, 'PromotionOriPrice' => $this
                        ->request
    ...
    public function AddComponent()
    {
            ...
            ->get('AdminisLoggedIn'))
        {
            ...
            {
                //Validation
                $rules = ['componentname' => 'required|min_length[5]|max_length[50]', 'componentimage' => 'uploaded[componentimage]|is_image[componentimage]|max_size[componentimage,4000]', 'componentdetails' => 'required|min_length[10]|max_length[255]', 'componentprice' => 'required|min_length[1]|max_length[50]|integer', ];
                ...
                else
                {
                    ...
                    $newData = ['ComponentName' => $this
                        ...
                        ->request
                        ->getVar('compbrand') , 'ComponentImage' => $image, 'ComponentDetails' => $this
                        ->request
    ...
    public function AddReward()
    {
            ...
            ->get('AdminisLoggedIn'))
        {
            ...
            {
                //Validation
                $rules = ['rewardname' => 'required|min_length[5]|max_length[50]', 'rewardimage' => 'uploaded[rewardimage]|is_image[rewardimage]|max_size[rewardimage,4000]', ];
                ...
                else
                {
                    ...
                    $newData = ['RewardName' => $this
                        ->request
                        ->getVar('rewardname') , 'RewardImage' => $image, 'RewardTier' => $this
                        ->request
                        ->getVar('rewardtier') , ];
                    $Result = $model->save($newData);
                    if ($Result)
    ...
    public function AddOrder()
    {
            ...
            ->get('AdminisLoggedIn'))
        {
            ...
            $UserModel = new UserModel();
            $data['useridData'] = $UserModel->orderBy('id', 'ASC')
                ->findAll();
            $payment_model = new payment_model();
            $data['paymntidData'] = $payment_model->orderBy('PaymentId', 'ASC')
                ->findAll();
                ...
                ->getMethod() == 'post')
            {
                ...
                'shippingadd' => 'required|min_length[10]|max_length[255]', 'itemordr' => 'required|min_length[10]|max_length[255]', 'itemtotal' => 'required|min_length[1]|max_length[20]|integer', ];
                ...
                else
                {
                    ...
                    $newData = ['userId' => $this
                        ->request
                        ->getVar('orderusrid') , 'paymentId' => $this
                        ->request
                        ->getVar('orderpaymntid') , 'shippingAddress' => $this
                        ->request
                        ->getVar('shippingadd') , 'itemsOrdered' => $this
                        ->request
                        ->getVar('itemordr') , 'grandTotal' => $this
                        ->request
                        ->getVar('itemtotal') , 'orderStatus' => $this
                        ->request
                        ->getVar('orderstatus') , ];
                    $Result = $model->save($newData);
                    if ($Result)
    ...
    public function AddCPU()
    {
            ...
            ->get('AdminisLoggedIn'))
        {
            ...
            {
                //Validation
                $rules = ['cpuprice' => 'required|min_length[3]|max_length[11]|integer', ];
                if (!$this->validate($rules))
                {
                    $data['validation'] = $this->validator;
                }
    ...
    public function AddGPU()
    {
            ...
            ->get('AdminisLoggedIn'))
        {
            ...
            {
                //Validation
                $rules = ['gpuprice' => 'required|min_length[4]|max_length[11]|integer', ];
                if (!$this->validate($rules))
                {
                    $data['validation'] = $this->validator;
                }
    ...
    public function AddAdmin()
    {
            ...
            ->get('AdminisLoggedIn'))
        {
            ...
            {
                //Validation
                $rules = ['staffname' => 'required|min_length[2]|max_length[25]', 'staffemail' => 'required|min_length[6]|max_length[50]|valid_email|is_unique[admin.staffEmail]', 'staffpassword' => 'required|min_length[8]|max_length[255]', 'staffpassword_confirm' => 'matches[staffpassword]', ];
                ...
                else
                {
                    ...
                    $newData = ['staffName' => $this
                        ->request
                        ->getVar('staffname') , 'staffEmail' => $this
                        ->request
                        ->getVar('staffemail') , 'stafPassword' => $this
                        ->request
                        ->getVar('staffpassword') , ];
                    $Result = $model->save($newData);
                    if ($Result)
                    {
                        $session = session();
